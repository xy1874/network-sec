...
|  设备名称   | IP地址  ||  ----  | ----  || R0-f0/1  | 192.168.1.254/24 || R0-f0/0  | 100.1.1.1/24 || R1-f0/1  | 200.1.1.1/24 || R1-f0/0  | 100.1.1.2/24 || R2-f0/1  | 200.1.1.2/24 || R2-f0/0  | 172.16.1.254/24 |

&emsp;&emsp;两台路PC机IP地址列表如下：
|  计算机   | IP地址  | 默认网关  |  ----  | ----  | ----  || P0  | 192.168.1.1 | 192.168.1.254 || P1  | 172.16.1.1 | 172.16.1.254 |
